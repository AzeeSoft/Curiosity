...
class ResearchShaderGUI : ShaderGUI
{
...
//            DoOutlineArea(material);
    ...
    void DoEmissionArea(Material material)
    {
        ...
        if (m_MaterialEditor.EmissionEnabledProperty())
        {
            ...
            m_MaterialEditor.TexturePropertyWithHDRColor(Styles.emissionText, emissionMap, emissionColorForRendering, new ColorPickerHDRConfig(0, 255, 0, 255), false);
