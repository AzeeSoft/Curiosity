...
void geomForwardBase(triangle VertexOutputForwardBase IN[3], inout TriangleStream<VertexOutputForwardBase> triStream)
{
    VertexOutputForwardBase o;
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    fixed4 col = OutputForward (c, s.alpha);
