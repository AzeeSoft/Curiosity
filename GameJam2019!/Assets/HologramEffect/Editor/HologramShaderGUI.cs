...
public class HologramShaderGUI : ShaderGUI
{
    ...
    private MaterialProperty UseLocalDirection = null;
    ...
    private MaterialProperty GlowIntensity = null;
    private MaterialProperty GlowAnimate = null;
    ...
    void AssignProperties()
    {
        ...
        UseLocalDirection = FindProperty("_UseLocalDirection", _props);
        ...
        GlowIntensity = FindProperty("_GlowIntensity", _props);
        GlowAnimate = FindProperty("_GlowAnimate", _props);
    ...
    void DrawGeneralEffect()
    {
        ...
        var ofs = EditorGUIUtility.labelWidth;
        _materialEditor.SetDefaultGUIWidths();
        _materialEditor.ShaderProperty(UseLocalDirection, "Use Local Direction");
    ...
    void DrawGlowSettings()
    {
        ...
        _materialEditor.ShaderProperty(GlowIntensity, "Intensity");
        _materialEditor.ShaderProperty(GlowAnimate, "Animate");
        EditorGUIUtility.labelWidth = ofs;
        EditorGUI.indentLevel--;
    }
